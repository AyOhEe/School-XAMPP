<html>
    ...
    <body>
        ...
        <form action="db_update_contact.php" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input maxlength="30" id="forename" name="forename" type="text" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input maxlength="30" id="surname" name="surname" type="text" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input maxlength="50" id="email" name="email" type="email" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <textarea maxlength="50" class="form-control input-md" id="address" name="address" type="text" placeholder=""></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input maxlength="8" id="postcode" name="postcode" type="text" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input maxlength="40" id="department" name="department" type="text" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button id="submit" name="submit" class="btn btn-primary">Update contact</button>
                </div>
            </div>
        </form>
    </body>
